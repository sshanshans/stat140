...
* #### Instructor
[Shan Shan](http://sshanshans.github.io)  (Assistant Professor of Statistics)

* #### Class Time and Location
Mon, Tue, Wed, Thur, Fri:  12:45PM (EST) on zoom

* #### Office hours

1. TTh: 2-3pm
2. Immediately after lecture: Just stick around
...
{{< expand "Piazza and Gradescope" >}} 

1. We use Piazza for Q&A
2. We use Gradescope for assignment submission.

Piazza and Gradescope access will be granted after enrollment to the class as we periodically synchronize with the official course roster.
{{< /expand >}}

<br> 

{{< expand "Course Materials" >}} 

* #### Textbook

Finding a good book is always a problem---none of the available texts is fully satisfactory. 
I will mostly follow the chapters in
...
We will be using the programming language R and Rstudio. R is one of the most commonly used programming languages in academic research and industry. Knowing R is a marketable skill. In this class, you will learn enough about R to conduct basic data analysis tasks.

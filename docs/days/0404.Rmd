...
- <input type="checkbox" unchecked> Finish watching [pre-recorded lecture](https://drive.google.com/drive/folders/1oRuhzqxohKmXeAezkU_a0ewtG9AqqjPA?usp=sharing). You could also find this video on the front page of the course moodle site.
</input>
- <input type="checkbox" unchecked> Finish working on the [tutorial exercise](https://sshanshans.github.io/stat140/labs/week4/0404.pdf) and check your answers [here](https://piazza.com/class_profile/get_resource/kge2lk8hfmxkz/khdo5uokizy79g). 
</input>

...
subtitle: "due Mon, Jan 21 at 11:59p"
output: 
  tufte::tufte_html:
    css: "./sta199-labs.css"
...
- Go to the STA199-Sp19 organization on GitHub ([https://github.com/STA199-Sp19](https://github.com/STA199-Sp19)). Click on the repo with the prefix **lab-01-hello-r-**. It contains the starter documents you need to complete the lab.
...
6. Resize your figures. Use the same value for `fig.width` and `fig.height`, so that your plots are square. Knit your document. 
...
7. Set the theme to something something other than "default". Knit your document again to see the new theme applied.

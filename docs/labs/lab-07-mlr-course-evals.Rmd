...
- Find the repo starting with `lab-07` and that has your team name at the end.
...
In this lab we will work with the `tidyverse` and `broom` packages. We can load them with the following:
...
- Click [here](http://www2.stat.duke.edu/courses/Spring19/sta199.001/labs/data/evals-mod.csv) to download the data. The file is called `evals-mod.csv`.

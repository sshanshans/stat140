...
author: "Shan Shan"
date: "Adpated from Mine Çetinkaya-Rundel"
output: 
  html_document: 
    toc: yes
    toc_float: yes
...
The data come from the Johns Hopkins University Center for Systems Science and Engineering (JHU CCSE) Coronavirus repository, and is updated daily.
...
## Two options
### Option 1. If you have connection to the MHC VPN. 
1. Connect to your MHC VPN
2. Open the link in your browser: https://138.110.84.108:3838/sshan/tutorials/u1d1
3. In the code blocks, change the country names to those you are interested in. Your spelling and capitalization should match how the countries appear in the data, so take a peek at the appendix at the end of this webpage to confirm spelling. 

### Option 2: If you don't have connection to the MHC VPN. 
1. Open the link in your browser: 
http://159.89.233.150:3838/stat140/tutorials/u1d1
2. In the code blocks, change the country names to those you are interested in. Your spelling and capitalization should match how the countries appear in the data, so take a peek at the appendix at the end of this webpage to confirm spelling. 

...
Use the StatKey website on [Sampling Distribution for a Proportion](Use the StatKey website to answer the following questions.) to answer the following questions.

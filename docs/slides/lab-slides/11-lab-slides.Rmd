...
[https://duke.qualtrics.com/jfe/form/SV_6WfAY1m6YiHUmIl](https://duke.qualtrics.com/jfe/form/SV_6WfAY1m6YiHUmIl)
...
- All code, R warnings, and R messages should be hidden so your document is neat and easy to read. At the top of your write up, include the following code: 
```{r eval = F}
...
- Extra credit: If we get 90% response rate on the course evaluation **and** post-study survey, everyone gets +5 points on their total (not average) HW score
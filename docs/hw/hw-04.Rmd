...
```{r echo=FALSE, fig.align="right",out.width="50%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("img/hw-04-inference.jpg")
```
...
9. Construct a 95% confidence interval for the difference in median incomes of employed Americans born in the first half of the year vs. those born in the in the second half.

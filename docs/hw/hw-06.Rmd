---
title: "HW 06 - Pick a package or two"
date: "Due: Wed, Apr 24 at 11:59p"
output: 
    html_document: 
     css: "./sta199-hw.css"
     toc: true
...
knitr::include_graphics("img/hw-06-pkg.png")
```

<br>

But really, one is enough. Pick a package from the list below, and use it to do something. If you want to use a package not on this list, that's also ok, but run it by me first (so that I can confirm it's not one we introduced in class so far, since the goal is to work with a new package).

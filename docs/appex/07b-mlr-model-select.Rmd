...
- In your R Markdown file, load the data the way we have been doing it in the course slides, paying attention to which character strings will be labelled as `NA`s when you read in the data. 

- Click [here](https://www2.stat.duke.edu/courses/Fall15/sta112.01/data/paris_paintings.html) for the full data dictionary.
...
- You should start with a list of at least 7 variables to consider, including interactions. You're allowed a maximum of 10 total variables to consider, including 
interactions. 
